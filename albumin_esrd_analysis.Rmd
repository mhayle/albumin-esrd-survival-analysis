...
first_data <- read.csv("usrdsData.csv")
alb <- read.csv("LongitudinalAlbumin.csv")
...
# CreateTableOne(data= (first_data %>% select(-trigly) %>% na.omit()),
#                vars=myVars, factorVars = catVars, test = FALSE, strata="death")
...
tab_full <- read.csv("table_one.csv")
...
#CreateTableOne(data=first_data, vars=myVars[-6], factorVars = catVars[-4], test = FALSE, strata=c("hist.cvd","death"))
...
tab_cvd <- read.csv("table_cvd.csv")
